                                                           ...
                                                           const std::vector<unsigned char>& buf)
{
    ...
    const std::vector<std::pair<const char*, const char*>> curve_constants = {
        {"secp256k1 prime", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F"},
        {"secp256r1 prime", "FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF"},
        {"secp384r1 prime", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF"},
        {"secp521r1 prime", "01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"},
        {"secp224r1 prime", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001"},
        {"secp224k1 prime", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"},
        {"brainpoolP256r1 prime", "A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377"},
        {"brainpoolP384r1 prime", "8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53"},
        {"brainpoolP512r1 prime", "AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E6"},
        {"Ed25519 prime", "7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFED"},
        {"Ed448 prime", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"}
    };

    for (const auto& param : curve_constants) {
        if (has(param.second)) {
            add(out, displayName, 0, param.first, param.second, "low");
        }
    }
